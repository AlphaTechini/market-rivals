...
| API routes                   | [src/routes/api](./src/routes/api/README.md)                     | Auth, arenas, rounds, picks, leaderboard, cron, me                     |
| Scheduled processing         | [src/routes/api/cron/README.md](./src/routes/api/cron/README.md) | Vercel Pro cron endpoint driving round lifecycle                       |
...
- To find round binding, settlement, scoring, achievements, and final ranking visit [src/lib/server/round-processor.ts](./src/lib/server/round-processor.ts).
